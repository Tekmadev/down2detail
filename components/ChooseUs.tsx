...
const getReasons = (t: any) => [
  {
    id: "premium-products",
    title: t("whyChooseUs.features.premiumProducts.title"),
    description: t("whyChooseUs.features.premiumProducts.description"),
    icon: (
      <svg
  ...
  {
    id: "fast-reliable",
    title: t("whyChooseUs.features.fastReliable.title"),
    description: t("whyChooseUs.features.fastReliable.description"),
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-12 w-12"
  ...
  },
  {
    ...
    title: t("whyChooseUs.features.protection.title"),
    description: t("whyChooseUs.features.protection.description"),
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-12 w-12"
