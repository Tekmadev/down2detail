...
export const metadata: Metadata = {
  ...
  description:
    "Explore Down2Detail's comprehensive auto detailing services in Montreal. Professional paint correction, ceramic coating, interior detailing, exterior wash, headlight restoration, and exterior detailing services. Expert care for all vehicle types.",
  openGraph: {
    title: "Professional Auto Detailing Services | Down2Detail Montreal",
    description:
      "Comprehensive auto detailing services including paint correction, ceramic coating, interior detailing, and exterior detailing services. Serving Montreal, Laval, and Greater Montreal Area.",
